...
document.querySelector('.x-btn').addEventListener('click', () => {
    ...
    document.querySelector('.container').style.cssText = ' background: linear-gradient(rgba(0, 0, 0, .8), rgba(0, 0, 0, .7) ),url(sign-up-form/assets/bg1.jpeg) no-repeat center center fixed; background-size: cover';
});